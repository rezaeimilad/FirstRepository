...
var markers = {
    pinball: { width: 1637, height: 2048, dpi: 215, url: "DataNFT/pinball" }
};
function start(
  container,
  marker,
  ...
  render_update
    ...
    var load = function () {
        ...
        var param = new ARCameraParam(
          "Data/camera_para-iPhone%205%20rear%20640x480%201.0m.dat"
        );
    ...
    var draw = function () {
        ...
        function glpointToCanvas(xyz) {
            return {
                x:
                  (((xyz.x + 1) * 0.5 * pw) / pscale) * sscale - (ox / pscale) * sscale,
